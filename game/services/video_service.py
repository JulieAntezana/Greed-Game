...
class VideoService:
    ...
    def draw_actor(self, actor):
        ...
        #increase the y in the game loop so the artifacts keep changing vertical position
        y_position = y + 1
        x_position = x
        
        #The if statement prevents the robot and banner from moving on the Y-axis
        if text != "#" and id != "banner":
            actor.set_position(Point(x_position, y_position))
